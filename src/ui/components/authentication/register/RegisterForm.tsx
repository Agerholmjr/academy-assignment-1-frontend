  ...
  return (
    <div className="flex h-full justify-center items-center w-full">
      <form className="sm:w-[400px] w-3/4 relative" onSubmit={handleSignUp}>
        ...
        <IonItem lines="none" color={'white-background'} className={`border-2 border-black ${emailValid ? 'border-grey-text' : 'border-yellow-500 border-4'} mt-8`}>
        ...
        <IonItem lines="none" color={'white-background'} className={`border-2 border-black ${passwordValid ? 'border-grey-text' : 'border-yellow-500 border-4'}`}>
          <IonInput
            value={password}
